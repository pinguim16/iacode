...
| `REQ-0140` | AUDIT_FINDING | `finding:M1-F-003` | yes | `COMPLETE` | `COMPLETE` | The published history cannot validate GATE-1-CP-0001, so every clean clone of the remote fails the mandatory tests gate |
| `REQ-0141` | AUDIT_FINDING | `finding:M1-F-001` | yes | `COMPLETE` | `COMPLETE` | A model is never shown the shape of a tool request, and the configured live model cannot make one |
| `REQ-0142` | AUDIT_FINDING | `finding:M1-F-002` | yes | `COMPLETE` | `COMPLETE` | The API accepts a tool result for a request the sandbox is executing, and the agent receives it instead of the sandbox's |
...
- Validation: `command:cmd-0070`, `command:cmd-0075`, `checkpoint:VERIFICATION-REPORT.json`
- Guardrail: _none_
...
- Implementation: `file:scripts/development-ledger/ledger_common.py`, `file:scripts/development-ledger/validate_checkpoint.py`, `file:scripts/development-ledger/m0_mirror_audit.py`, `file:scripts/development-ledger/m0_red_team.py`, `file:scripts/development-ledger/remote_sync.py`, `file:docs/adr/ADR-0028-sealed-evidence-is-judged-from-the-published-history.md`, `command:cmd-0014`, `command:cmd-0015`
- Test: `test:PublishedHistoryTests`, `test:PreservedReferenceTests`, `test:CloneMethodTests`, `test:test_every_sealed_checkpoint_validates_from_its_own_tag`, `test:test_a_preserved_reference_missing_from_the_remote_fails_unnamed`
- Negative test: `checkpoint:OLD-CODE-M1-F-003.json`, `checkpoint:VALIDATOR-BLIND-SPOT.json`, `test:test_the_validator_refuses_a_record_naming_an_unpublished_commit`
- Documentation: `file:docs/CHECKPOINT-PROTOCOL.md`, `file:docs/HANDOFF-PROTOCOL.md`, `file:docs/DEVELOPMENT-CONTRACT.md`
- Validation: `command:cmd-0016`, `checkpoint:REMOTE-PUBLISHED-OBJECTS.json`, `command:cmd-0031`, `command:cmd-0100`, `checkpoint:CLEAN-CLONE-REPORT.json`, `command:cmd-0098`, `checkpoint:SEALED-SUBJECTS-PUBLISHED.json`, `command:cmd-0070`, `checkpoint:VERIFICATION-REPORT.json`
...
- Implementation: `file:services/agent-runtime/src/iacode_agent_runtime/protocol.py`, `file:services/agent-runtime/src/iacode_agent_runtime/context.py`, `file:services/agent-runtime/src/iacode_agent_runtime/engine.py`, `file:docs/adr/ADR-0022-agent-output-envelope.md`
- Test: `test:test_the_runtime_instructions_show_the_exact_envelope_of_every_kind`, `test:test_the_tool_request_example_carries_a_name_and_arguments`, `test:test_the_repair_restates_the_same_shape`, `test:test_the_rendered_contract_follows_the_schema`, `test:test_the_instructions_follow_a_change_of_the_canonical_schema`, `test:test_no_second_envelope_contract_is_written_by_hand`, `test:test_every_example_is_a_valid_envelope_of_its_kind`, `test:test_the_repair_carries_the_shape_with_the_stage_tools`
- Negative test: `test:test_arguments_outside_tool_arguments_are_refused_by_their_real_defect`, `file:docs/checkpoints/GATE-3-CP-0002/CROSS-GATE-LIVE-ATTEMPT-2.json`, `file:docs/checkpoints/GATE-3-CP-0002/CROSS-GATE-LIVE-ATTEMPT-3.json`
- Documentation: `file:docs/adr/ADR-0022-agent-output-envelope.md`
- Validation: `command:cmd-0035`, `command:cmd-0041`, `checkpoint:LIVE-CODING-RUN.json`, `command:cmd-0070`, `checkpoint:VERIFICATION-REPORT.json`
- Guardrail: `file:.iacode/memory/guardrails/registry.json`
...
- Implementation: `file:services/agent-runtime/src/iacode_agent_runtime/persistence.py`, `file:services/agent-runtime/src/iacode_agent_runtime/service.py`, `file:services/orchestrator/src/iacode_orchestrator/agent_runtime/activities.py`, `file:services/orchestrator/src/iacode_orchestrator/workflows/agent_run.py`, `file:apps/api/migrations/versions/0005_tool_request_executor.py`, `file:apps/api/src/iacode_api/routes/agent_runs.py`, `file:packages/contracts/src/iacode_contracts/agent_runtime.py`
- Test: `test:test_a_forged_result_cannot_displace_the_sandbox_result`, `test:test_a_manual_result_for_a_manual_request_is_accepted`, `test:test_a_duplicate_sandbox_result_is_idempotent`, `test:test_every_caller_declares_a_constant_origin`, `test:test_a_result_for_a_request_the_sandbox_owns_is_refused_and_never_signalled`, `test:test_existing_requests_are_backfilled_from_what_the_sandbox_executed`, `test:ToolResultOriginTests`
- Negative test: `test:test_a_manual_result_for_a_sandbox_request_is_refused`, `test:test_a_forged_result_after_the_run_ended_is_refused`, `test:test_a_sandbox_request_of_another_run_is_refused_as_another_run`, `file:docs/checkpoints/GATE-3-CP-0002/FORGED-RESULT-PROBE.json`
- Documentation: `file:docs/runbooks/SANDBOX.md`, `file:docs/runbooks/AGENT-RUNTIME.md`
- Validation: `command:cmd-0038`, `command:cmd-0039`, `command:cmd-0055`, `checkpoint:TOOL-RESULT-ORIGIN.json`, `command:cmd-0087`, `command:cmd-0070`, `checkpoint:VERIFICATION-REPORT.json`
- Guardrail: `file:.iacode/memory/guardrails/registry.json`
...
- Implementation: `file:.iacode/memory/lessons.jsonl`
- Test: `test:DeliveryAssuranceGateTests.test_gate_consistency_is_provisional_while_work_is_in_progress`, `test:test_every_runner_of_the_mandatory_gates_refreshes_the_declared_hashes`, `test:test_the_refresh_has_one_definition`, `test:test_no_other_module_executes_the_mandatory_gate_set`
- Negative test: _none_
- Documentation: `file:docs/ENGINEERING-MEMORY.md`
- Validation: `command:cmd-0070`, `command:cmd-0075`, `checkpoint:VERIFICATION-REPORT.json`
- Guardrail: `file:.iacode/memory/guardrails/registry.json`
...
- Documentation: `file:docs/ENGINEERING-MEMORY.md`
- Validation: `command:cmd-0070`, `command:cmd-0075`, `checkpoint:VERIFICATION-REPORT.json`
- Guardrail: `file:.iacode/memory/guardrails/registry.json`, `file:.iacode/memory/guardrails/registry.json`
...
- Implementation: `file:.iacode/memory/lessons.jsonl`
- Test: `test:test_internal_error_still_carries_a_correlation_identifier`, `test:test_internal_error_leaks_nothing`, `test:test_a_missing_route_uses_the_error_contract`
- Negative test: _none_
- Documentation: `file:docs/ENGINEERING-MEMORY.md`
- Validation: `command:cmd-0070`, `command:cmd-0075`, `checkpoint:VERIFICATION-REPORT.json`
- Guardrail: `file:.iacode/memory/guardrails/registry.json`
...
- Implementation: `file:.iacode/memory/lessons.jsonl`
- Test: `test:test_no_source_file_carries_a_stray_control_character`, `test:test_the_scan_detects_one`, `test:test_the_page_offers_nothing_that_would_execute_a_tool`, `test:test_the_boundary_has_something_to_scan`
- Negative test: _none_
- Documentation: `file:docs/ENGINEERING-MEMORY.md`
- Validation: `command:cmd-0070`, `command:cmd-0075`, `checkpoint:VERIFICATION-REPORT.json`
- Guardrail: `file:.iacode/memory/guardrails/registry.json`
...
- Implementation: `file:.iacode/memory/lessons.jsonl`
- Test: `test:test_the_agent_runtime_migration_is_reversible`, `test:test_the_declared_model_matches_the_migrated_schema`, `test:test_a_check_constraint_is_created_and_dropped_by_its_bare_name`, `test:test_a_unique_constraint_keeps_exactly_the_name_it_was_given`
- Negative test: _none_
- Documentation: `file:docs/ENGINEERING-MEMORY.md`
- Validation: `command:cmd-0070`, `command:cmd-0075`, `checkpoint:VERIFICATION-REPORT.json`
- Guardrail: `file:.iacode/memory/guardrails/registry.json`
...
- Implementation: `file:.iacode/memory/lessons.jsonl`
- Test: `test:test_readiness_is_asked_of_temporal`, `test:test_readiness_is_not_read_from_a_log_line`, `test:test_the_harness_asks_the_server_for_the_answer`
- Negative test: _none_
- Documentation: `file:docs/ENGINEERING-MEMORY.md`
- Validation: `command:cmd-0070`, `command:cmd-0075`, `checkpoint:VERIFICATION-REPORT.json`
- Guardrail: `file:.iacode/memory/guardrails/registry.json`
...
- Implementation: `file:.iacode/memory/lessons.jsonl`
- Test: `test:test_the_null_control_detects_a_mutation`, `test:test_the_provider_scan_would_catch_one`, `test:test_the_credential_scan_would_catch_one`, `test:test_the_scan_detects_a_module_that_does_it`, `test:test_the_determinism_scan_detects_a_module_that_breaks_it`
- Negative test: _none_
- Documentation: `file:docs/ENGINEERING-MEMORY.md`
- Validation: `command:cmd-0070`, `command:cmd-0075`, `checkpoint:VERIFICATION-REPORT.json`
- Guardrail: `file:.iacode/memory/guardrails/registry.json`
...
- Implementation: `file:.iacode/memory/lessons.jsonl`
- Test: `test:test_no_counted_pytest_case_expands_at_run_time`, `test:test_the_scan_detects_an_expansion`
- Negative test: _none_
- Documentation: `file:docs/ENGINEERING-MEMORY.md`
- Validation: `command:cmd-0070`, `command:cmd-0075`, `checkpoint:VERIFICATION-REPORT.json`
- Guardrail: `file:.iacode/memory/guardrails/registry.json`
...
- Implementation: `file:.iacode/memory/lessons.jsonl`
- Test: `test:test_the_engine_is_not_wrapped_in_wait_for`, `test:test_the_deadline_races_an_explicit_child_task`, `test:test_the_wait_accepts_every_way_a_cancelled_activity_surfaces`, `test:test_the_deadline_path_writes_the_failure_down`, `test:test_the_scenario_asserts_the_run_ended_and_said_so`
- Negative test: _none_
- Documentation: `file:docs/ENGINEERING-MEMORY.md`
- Validation: `command:cmd-0070`, `command:cmd-0075`, `checkpoint:VERIFICATION-REPORT.json`
- Guardrail: `file:.iacode/memory/guardrails/registry.json`
...
- Implementation: `file:.iacode/memory/lessons.jsonl`
- Test: `test:test_content_of_the_wrong_type_is_refused_by_its_real_defect`, `test:test_the_runtime_instructions_state_that_content_is_one_string`
- Negative test: _none_
- Documentation: `file:docs/ENGINEERING-MEMORY.md`
- Validation: `command:cmd-0070`, `command:cmd-0075`, `checkpoint:VERIFICATION-REPORT.json`
- Guardrail: `file:.iacode/memory/guardrails/registry.json`
...
- Implementation: `file:.iacode/memory/lessons.jsonl`
- Test: `test:test_a_terminal_state_is_never_visible_before_its_terminal_event`, `test:test_the_workflow_writes_the_terminal_event_before_the_terminal_state`, `test:test_a_workflow_that_cannot_start_fails_the_run_rather_than_leaving_it_created`
- Negative test: _none_
- Documentation: `file:docs/ENGINEERING-MEMORY.md`
- Validation: `command:cmd-0070`, `command:cmd-0075`, `checkpoint:VERIFICATION-REPORT.json`
- Guardrail: `file:.iacode/memory/guardrails/registry.json`
...
- Implementation: `file:.iacode/memory/lessons.jsonl`
- Test: `test:test_every_script_that_reads_prometheus_waits_for_a_scrape`, `test:test_the_scan_fires_on_a_read_that_does_not_wait`, `test:test_the_foundation_smoke_waits_for_both_targets_and_asks_only_prometheus`, `test:test_the_observability_check_waits_for_a_scrape_and_asks_only_prometheus`, `test:test_live_smoke_is_bounded_and_minimal`
- Negative test: _none_
- Documentation: `file:docs/ENGINEERING-MEMORY.md`
- Validation: `command:cmd-0070`, `command:cmd-0075`, `checkpoint:VERIFICATION-REPORT.json`
- Guardrail: `file:.iacode/memory/guardrails/registry.json`
...
- Implementation: `file:.iacode/memory/lessons.jsonl`
- Test: `test:test_sealing_refuses_a_state_that_does_not_name_its_own_tag`, `test:test_a_symbolic_head_validates_from_its_own_canonical_tag`, `test:test_a_symbolic_head_away_from_its_canonical_tag_is_still_refused`, `test:test_every_sealed_checkpoint_validates_from_its_own_tag`
- Negative test: _none_
- Documentation: `file:docs/ENGINEERING-MEMORY.md`
- Validation: `command:cmd-0070`, `command:cmd-0075`, `checkpoint:VERIFICATION-REPORT.json`
- Guardrail: `file:.iacode/memory/guardrails/registry.json`
...
- Implementation: `file:.iacode/memory/lessons.jsonl`
- Test: `test:test_the_runtime_accepts_every_result_the_sandbox_hands_over`, `test:test_an_escaped_output_is_shortened_to_the_bound_and_says_so`, `test:test_an_output_that_fits_is_handed_over_unchanged`
- Negative test: _none_
- Documentation: `file:docs/ENGINEERING-MEMORY.md`
- Validation: `command:cmd-0070`, `command:cmd-0075`, `checkpoint:VERIFICATION-REPORT.json`
- Guardrail: `file:.iacode/memory/guardrails/registry.json`
...
- Implementation: `file:.iacode/memory/lessons.jsonl`
- Test: `test:test_both_sides_name_the_result_by_the_shared_key`, `test:test_the_key_scan_detects_a_literal`, `test:test_the_activity_answers_the_agent_result_and_the_execution`
- Negative test: _none_
- Documentation: `file:docs/ENGINEERING-MEMORY.md`
- Validation: `command:cmd-0070`, `command:cmd-0075`, `checkpoint:VERIFICATION-REPORT.json`
- Guardrail: `file:.iacode/memory/guardrails/registry.json`
...
- Implementation: `file:.iacode/memory/lessons.jsonl`
- Test: `test:test_a_fork_bomb_that_detaches_leaves_a_sandbox_that_still_answers`, `test:test_a_fork_bomb_is_contained_by_the_process_limit`, `test:test_a_timeout_kills_the_whole_process_tree`
- Negative test: _none_
- Documentation: `file:docs/ENGINEERING-MEMORY.md`
- Validation: `command:cmd-0070`, `command:cmd-0075`, `checkpoint:VERIFICATION-REPORT.json`
- Guardrail: `file:.iacode/memory/guardrails/registry.json`
...
- Negative test: _none_
- Documentation: `file:docs/ENGINEERING-MEMORY.md`
- Validation: `command:cmd-0070`, `command:cmd-0075`, `checkpoint:VERIFICATION-REPORT.json`, `command:cmd-0053`, `command:cmd-0062`
- Guardrail: _none_
...
- Implementation: `file:.iacode/memory/lessons.jsonl`
- Test: `test:test_a_forged_result_cannot_displace_the_sandbox_result`, `test:test_a_manual_result_for_a_sandbox_request_is_refused`, `test:test_a_result_for_a_request_the_sandbox_owns_is_refused_and_never_signalled`, `test:test_every_caller_declares_a_constant_origin`, `test:test_existing_requests_are_backfilled_from_what_the_sandbox_executed`
- Negative test: _none_
- Documentation: `file:docs/ENGINEERING-MEMORY.md`
- Validation: `command:cmd-0070`, `command:cmd-0075`, `checkpoint:VERIFICATION-REPORT.json`
- Guardrail: `file:.iacode/memory/guardrails/registry.json`
