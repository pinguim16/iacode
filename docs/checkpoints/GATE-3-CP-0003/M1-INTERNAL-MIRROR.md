...
- Generated: `2026-09-23T09:25:23Z`
- Target fingerprint: `13a1871843aa976c824508e4617cbe0740f710ee9baff0df222c6bd85cd8a25f`
...
| `MIR-002` | Audit findings | Every finding of every audit whose corrective delivery this is, is CLOSED. | 3/3 audit findings CLOSED | PASS |
...
| `MIR-004` | Engineering Memory | The memory validates. | LESSONS_VALID total=56 active=56 guarded=53 | PASS |
| `MIR-005` | Lessons | No lesson carries an unresolved guardrail failure. | 56 lessons, 53 GUARDED, 3 CONFIRMED, 0 with an unresolved guardrail failure | PASS |
| `MIR-006` | Guardrails | Every guardrail resolves, is verified by a test, and has no unresolved failure. | 57/57 effective, 57 resolved, 57 tested, 0 failures | PASS |
...
| `MIR-009` | Delivery Completeness | Coverage and evidence coverage are total over the derived expected set. | 197/197 complete; 197 anchored against an expected set of 197 and 0 declared locally, coverage 100.00, evidence 100.00 | PASS |
| `MIR-010` | History integrity | The sealed checkpoint chain resolves. | 19 anchors verified | PASS |
| `MIR-011` | Tags | Every anchored tag resolves to its anchored commit. | 19 tags resolve to their anchored commits | PASS |
...
| `MIR-013` | Command reproducibility | Every record that names an input binds it by content. | 106 records, 0 without an input digest, 9 recorded failures kept in the ledger | PASS |
| `MIR-014` | Derived counts | Every evidential count matches its derivation. | ATTACKS=27/27; FINDINGS=3/3; GUARDRAILS=57/57; LESSONS=53/56; REQUIREMENTS=197/197; TESTS=1548/1548 | PASS |
| `MIR-015` | Documentation | Every relative documentation link resolves. | 187/187 relative documentation links resolve | PASS |
| `MIR-016` | Historical compatibility | Every sealed checkpoint still validates under the tooling this Gate changes, from a clone that carries only the published history. | 19 sealed checkpoints validate under this tooling | PASS |
