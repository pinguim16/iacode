# Requirements Matrix - SETUP-00-CP-0010
...
| `REQ-0068` | `canonical:SETUP-00#8.1` | yes | `NOT_STARTED` | An independent review is recorded. | docs/SETUP-00-CHECKLIST.md row 8.1 |
| `REQ-0069` | `canonical:SETUP-00#8.2` | yes | `NOT_STARTED` | An adversarial Red Team is recorded. | docs/SETUP-00-CHECKLIST.md row 8.2 |
| `REQ-0070` | `canonical:SETUP-00#8.3` | yes | `NOT_STARTED` | `GATE_PASS` is granted only by a run independent of the implementer. | docs/SETUP-00-CHECKLIST.md row 8.3 |
| `REQ-0071` | `canonical:SETUP-00#9.1` | yes | `NOT_STARTED` | No Gate 0 or later runtime is implemented during SETUP-00. | docs/SETUP-00-CHECKLIST.md row 9.1 |
| `REQ-0072` | `canonical:SETUP-00#9.2` | yes | `NOT_STARTED` | Documentation is maintained continuously rather than reconstructed at the end. | docs/SETUP-00-CHECKLIST.md row 9.2 |
| `REQ-0073` | `canonical:SETUP-00#9.3` | yes | `NOT_STARTED` | No secret, credential, or private chain-of-thought is stored. | docs/SETUP-00-CHECKLIST.md row 9.3 |
| `REQ-0074` | `canonical:SETUP-00#9.4` | yes | `NOT_STARTED` | Gate advancement requires explicit authorization and a passing previous Gate. | docs/SETUP-00-CHECKLIST.md row 9.4 |
| `REQ-0075` | `finding:CP9-F-001` | yes | `NOT_STARTED` | the external audit attestation can be written but never consumed, so `MILESTONE_EXTERNAL_PASS` is unreachable | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/REVIEW-REPORT.md CP9-F-001 |
| `REQ-0076` | `finding:CP9-F-002` | yes | `NOT_STARTED` | a guardrail test is bound to a literal checkpoint name, so performing the protocol's own next step turns the mandatory `tests` gate red | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/REVIEW-REPORT.md CP9-F-002 |
| `REQ-0077` | `finding:CP9-F-003` | yes | `NOT_STARTED` | a stale count survives in a current artifact because the count guardrail only inspects Markdown | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/REVIEW-REPORT.md CP9-F-003 |
| `REQ-0078` | `finding:CP9-F-004` | yes | `NOT_STARTED` | a lesson's own note contradicts its status | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/REVIEW-REPORT.md CP9-F-004 |
| `REQ-0079` | `finding:CP9-F-005` | yes | `NOT_STARTED` | a policy key is declared and never read | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/REVIEW-REPORT.md CP9-F-005 |
| `REQ-0080` | `attack:A` | yes | `NOT_STARTED` | Defend attack A: Add a blocker to a READY_FOR_REVIEW checkpoint | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack A |
| `REQ-0081` | `attack:B` | yes | `NOT_STARTED` | Defend attack B: Set a review-ready quality dimension red | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack B |
| `REQ-0082` | `attack:C` | yes | `NOT_STARTED` | Defend attack C: Delete a canonical requirement and recompute every count | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack C |
| `REQ-0083` | `attack:D` | yes | `NOT_STARTED` | Defend attack D: Forge the stored counts of a passing report | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack D |
| `REQ-0084` | `attack:E` | yes | `NOT_STARTED` | Defend attack E: Remove a lesson-derived requirement from the matrix | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack E |
| `REQ-0085` | `attack:F` | yes | `NOT_STARTED` | Defend attack F: Replace a preventive control with documentation only | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack F |
| `REQ-0086` | `attack:G` | yes | `NOT_STARTED` | Defend attack G: Duplicate a lesson identifier | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack G |
| `REQ-0087` | `attack:H` | yes | `NOT_STARTED` | Defend attack H: Insert a secret-shaped value into a scanned field | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack H |
| `REQ-0088` | `attack:I` | yes | `NOT_STARTED` | Defend attack I: Rewrite a sealed predecessor, refresh hashes and move its tag | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack I |
| `REQ-0089` | `attack:J` | yes | `NOT_STARTED` | Defend attack J: Move a checkpoint tag and HEAD together | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack J |
| `REQ-0090` | `attack:K` | yes | `NOT_STARTED` | Defend attack K: Remove one inventory entry | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack K |
| `REQ-0091` | `attack:L` | yes | `NOT_STARTED` | Defend attack L: Silently modify a tracked file | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack L |
| `REQ-0092` | `attack:M` | yes | `NOT_STARTED` | Defend attack M: Set a wrong hashBefore | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack M |
| `REQ-0093` | `attack:N` | yes | `NOT_STARTED` | Defend attack N: Set a wrong hashAfter | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack N |
| `REQ-0094` | `attack:O` | yes | `NOT_STARTED` | Defend attack O: Claim PASS with no evidence | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack O |
| `REQ-0095` | `attack:P` | yes | `NOT_STARTED` | Defend attack P: Reference an unknown command | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack P |
| `REQ-0096` | `attack:Q` | yes | `NOT_STARTED` | Defend attack Q: Supply complete attribution with empty evidence | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack Q |
| `REQ-0097` | `attack:R` | yes | `NOT_STARTED` | Defend attack R: Promote an internally authored result to an external status | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack R |
| `REQ-0098` | `attack:S` | yes | `NOT_STARTED` | Defend attack S: Leave review and Red Team pending with a null auditor | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack S |
| `REQ-0099` | `attack:T` | yes | `NOT_STARTED` | Defend attack T: Request an audit without a known trigger | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack T |
| `REQ-0100` | `attack:U` | yes | `NOT_STARTED` | Defend attack U: Retire a canonical lesson but keep the active preflight | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack U |
| `REQ-0101` | `attack:V` | yes | `NOT_STARTED` | Defend attack V: Run the Green Keeper with an empty gate selection | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack V |
| `REQ-0102` | `attack:W` | yes | `NOT_STARTED` | Defend attack W: Claim PASS with a PARTIAL requirement | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack W |
| `REQ-0103` | `attack:X` | yes | `NOT_STARTED` | Defend attack X: Remove a required field from a command record | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack X |
| `REQ-0104` | `attack:Y` | yes | `NOT_STARTED` | Defend attack Y: Point LATEST.md at an older checkpoint | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack Y |
| `REQ-0105` | `attack:Z` | yes | `NOT_STARTED` | Defend attack Z: Use path traversal as the Gate identifier | M0-CP-0009 docs/checkpoints/SETUP-00-CP-0009/RED-TEAM-REPORT.md attack Z |
