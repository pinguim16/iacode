...
- Generated: `2026-09-22T17:35:01Z`
...
| Metric | Value |
|---|---|
| expectedRequirements | 182 |
| totalRequirements | 182 |
| mandatoryRequirements | 181 |
| complete | 179 |
| partial | 0 |
| missing | 3 |
| notApplicable | 0 |
...
|---|---|---|
| `REQ-0127` | BLOCKING | requirement is MISSING and cannot ship |
| `REQ-0128` | BLOCKING | requirement is MISSING and cannot ship |
| `REQ-0131` | BLOCKING | requirement is MISSING and cannot ship |
...
| `REQ-0127` | yes | `MISSING` | `file:scripts/iacode/agent_runtime_smoke.py` |
| `REQ-0128` | yes | `MISSING` | `file:scripts/iacode/agent_runtime_smoke.py` |
...
| `REQ-0131` | yes | `MISSING` | `file:scripts/iacode/agent_runtime_smoke.py` |
