...
- Gate: `SETUP-00`
- Scope: `M0 closure: correct every finding of the independent M0 audit and re-establish the delivery controls`
- Technologies: `python`, `git`
- Modules: `development-ledger`, `engineering-memory`, `checkpoint-protocol`
- Generated: `2026-09-20T19:36:30Z`
- Lessons considered: 23
- Lessons applicable: 23
...
| `LSN-0022` An authoritative count must be derived once, never maintained by hand twice | `GUARDED` | HIGH | `LESSON-REQ-0022` | Confirm that every count used as evidence in this Gate is derived from one source and verified where it is quoted. |
...
- Reason: applies to every Gate; category documentation; severity HIGH; already guarded, so the control must keep holding
