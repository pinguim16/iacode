...
- Generated: `2026-09-22T21:26:15Z`
- Target fingerprint: `5ee9aec5c532bb9755a7d4bc3c3059629e0938df8c1a83e52ff609ac0dae6921`
...
|---|---|---|---|---|
| `MIR-001` | Gate specification requirements | Every row of the canonical Gate specification is declared and COMPLETE. | 137/137 canonical rows COMPLETE | PASS |
...
| `MIR-004` | Engineering Memory | The memory validates. | LESSONS_VALID total=50 active=50 guarded=48 | PASS |
| `MIR-005` | Lessons | No lesson carries an unresolved guardrail failure. | 50 lessons, 48 GUARDED, 2 CONFIRMED, 0 with an unresolved guardrail failure | PASS |
| `MIR-006` | Guardrails | Every guardrail resolves, is verified by a test, and has no unresolved failure. | 52/52 effective, 52 resolved, 52 tested, 0 failures | PASS |
...
| `MIR-009` | Delivery Completeness | Coverage and evidence coverage are total over the derived expected set. | 186/186 complete; 186 anchored against an expected set of 186 and 0 declared locally, coverage 100.00, evidence 100.00 | PASS |
| `MIR-010` | History integrity | The sealed checkpoint chain resolves. | 16 anchors verified | PASS |
| `MIR-011` | Tags | Every anchored tag resolves to its anchored commit. | 16 tags resolve to their anchored commits | PASS |
...
| `MIR-013` | Command reproducibility | Every record that names an input binds it by content. | 70 records, 0 without an input digest, 6 recorded failures kept in the ledger | PASS |
| `MIR-014` | Derived counts | Every evidential count matches its derivation. | ATTACKS=22/22; GUARDRAILS=52/52; LESSONS=48/50; REQUIREMENTS=186/186; TESTS=1232/1232 | PASS |
| `MIR-015` | Documentation | Every relative documentation link resolves. | 129/129 relative documentation links resolve | PASS |
| `MIR-016` | Historical compatibility | Every sealed checkpoint still validates under the tooling this Gate changes. | 16 sealed checkpoints validate under this tooling | PASS |
