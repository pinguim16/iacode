# IACode VS Code extension

**Status: RESERVED — NOT IMPLEMENTED.** This directory is scheduled for `GATE 5`.

The editor integration that exposes the governed workflows.
